...
def main():
    ...
    try:
        ...
        while time.monotonic()<deadline:
            ...
            if all(states.get(n)=='active' for n in ['joint_state_broadcaster','arm_controller']):break
        ...
        expected={'work_surface','pickup_cube','pickup_sphere','hanoi_stand','hanoi_ring_large','hanoi_ring_medium','hanoi_ring_small'}
        ...
        print('PASS: seven scene models, active controllers, FK/IK, rejected tilt, collision-checked MoveIt plan, execution and joint-state feedback.')
